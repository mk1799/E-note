...
<body>
		...
		<form class="input-form" action="book_up.php" method="post">
			
			
			<input type="text" name="bn" placeholder="Subject Name & Code" required>
			<br>
			<input type="text" name="pn" placeholder="Publication Name" required>
			<br>
			<input type="text" name="yoe" placeholder="Year Of Edition" required>
			<br>
